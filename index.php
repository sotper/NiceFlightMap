...
?>
        ...
        <title>联飞地图-中国蓝天模拟飞行论坛CBS V1.0</title>
    </head>
    <body>
    <div class="body">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-4">
                    <ul class="nav navbar-nav">
                        <li><a href="http://bbs.cbsflight.cn/forum.php">论坛</a></li>
                        <li><a href="http://map.cbsflight.cn/">联飞地图</a></li>
                        <li><a href="http://cs.cbsflight.cn/">呼号系统</a></li>
                        <li><a href="http://aq.cbsflight.cn/">飞行器注册号查询</a></li>
                    </ul>
                    <p class="navbar-text">
                        航空模拟
                    </p>
        ...
        <script>
            ...
            var fsd={
                ...
                stru_pilot:function () {
                    ...
                    var getkey=["航班号","呼号","起飞机场","降落机场","平台"];
                    ...
                    {
						pilot_items[i][getkey[4]]='CBS';
                        var $tmp_tr=$(document.createElement("tr"));


                        $tmp_tr.addClass('table_info_tr');
                        $tmp_tr.attr("id",pilot_items[i]['呼号']+"_p");//设置属性
...
//                        this.gdmap.setFitView();
                ...
                info_panel:function (pilot) {
                    var self=this;
                    var info_body="";
                    var key_list=['航班号','呼号','平台','客户端','机型','应答机','计划巡航高度','当前高度','当前速度','起飞机场','降落机场','备降机场','经度','纬度','航路','席位','名称','频率','雷达范围'];
